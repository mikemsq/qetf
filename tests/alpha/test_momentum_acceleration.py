...
class TestMomentumAccelerationBasics:
    ...
    def test_positive_acceleration_scenario(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Long return: (132 / 100) - 1 = 0.32 = 32%
            # Short return: (132 / 110) - 1 = 0.20 = 20%
            # Acceleration: 0.20 - 0.32 = -0.12 (actually negative!)
            # Wait, let me recalculate...

            # Actually with this price path:
            # Start (252 days ago): 100
            # End (now): 132
            # Long return = 32%
            #
            # Start of short window (63 days ago): 110
            # End (now): 132
            # Short return = 20%
            #
            # Acceleration = 20% - 32% = -12% (NEGATIVE!)
            # This means deceleration, not acceleration.
    ...
    def test_positive_acceleration_corrected(self):
        ...
        # TICKER_A: Slow growth first 9 months, fast growth last 3 months
        # This will show acceleration
        #
        # Total 12M return target: +20%
        # Last 3M return target: +15%
        # This means first 9M contributed only +5%
        # Acceleration = +15% - +20% = -5% (still wrong!)
        #
        # Let me think differently:
        # If 12M return = 20% and 3M return = 25%
        # Then acceleration = 25% - 20% = +5% (positive!)

        # Build price path that achieves this
        # Need: (price_end / price_252d_ago) - 1 = 0.20
        # Need: (price_end / price_63d_ago) - 1 = 0.25

        # Work backwards:
        # price_end = 120 (arbitrary choice)
        # price_252d_ago = 120 / 1.20 = 100
        # price_63d_ago = 120 / 1.25 = 96

        # So price goes from 100 down to 96 over first 189 days,
        # then up to 120 over last 63 days
    ...
    def test_negative_acceleration_scenario(self):
        ...
        # This shows deceleration
        # price_end = 130
        # price_252d_ago = 130 / 1.30 = 100
        # price_63d_ago = 130 / 1.05 = 123.8
